 ...
 function PopulateWebpanel(val)
 {
	...
	if(P2[0] == "BASIC"){
		...
		try { if(array[0] == 'Record..') { document.getElementById('txtRecord').checked = true;  } else { document.getElementById('txtRecord').checked = false; } 	} catch (error) { console.error(error); }
		try { if(array[0] == 'Scanner..') { document.getElementById('txtScanner').checked = true;  } else { document.getElementById('txtScanner').checked = false; } 	} catch (error) { console.error(error); }
		try { if(array[0] == 'Bruteforcer..') { document.getElementById('txtBruteforcer').checked = true;  } else { document.getElementById('txtBruteforcer').checked = false; } 	} catch (error) { console.error(error); }
		try { if(array[0] == 'Jammer..') { document.getElementById('txtJammer').checked = true;  } else { document.getElementById('txtJammer').checked = false; } 	} catch (error) { console.error(error); }
		try { if(array[0] == 'Rolljam..') { document.getElementById('txtRolljam').checked = true;  } else { document.getElementById('txtRolljam').checked = false; } 	} catch (error) { console.error(error); }
		try { if(array[0] == 'Rollback..') { document.getElementById('txtRollback').checked = true;  } else { document.getElementById('txtRollback').checked = false; } 	} catch (error) { console.error(error); }
		...
		try { document.getElementById("txtJAMFRQ").value = array[29]; } catch (error) { console.error(error); }
		
		try { document.getElementById('rollPreset' + array[24]).checked = true; } catch (error) { console.error(error); }
		try { document.getElementById("txtROLLFRQ").value = array[25]; } catch (error) { console.error(error); }
		try { document.getElementById("txtFRAME").value = array[26]; } catch (error) { console.error(error); }
		try { document.getElementById("txtREQUIRED").value = array[27]; } catch (error) { console.error(error); }
		  
		try { document.getElementById("txtIP").value = array[28]; } catch (error) { console.error(error); }
		
		try { document.getElementById("txtFOLDER").value = array[30]; } catch (error) { console.error(error); }
		
		try { document.getElementById("txtUPTIME").innerHTML = array[2]; } catch (error) { console.error(error); }
		try { document.getElementById("txtRAM").innerHTML = array[31]; } catch (error) { console.error(error); }
		...
		try {
			...
			var mod = "";
			if(parsed[1] == "2") { mod = "ASK/OOK" } else { mod = "2_FSK" }
	
			const cell5 = document.createElement("td");
			const cell5Text = document.createTextNode(parsed[0] + " - Modulation: " + mod + " - Bandwidth: " + parsed[2]);
